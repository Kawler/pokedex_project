...
object PokemonTypeSingleton {
    val pokemonTypeList: List<PokemonTypeListItem> = listOf(
        ...
        PokemonTypeListItem(PokemonType.FIRE, "#F08030", "#FFFFFF"),     // Fire
        PokemonTypeListItem(PokemonType.WATER, "#6890F0", "#FFFFFF"),    // Water
        ...
        PokemonTypeListItem(PokemonType.POISON, "#A040A0", "#FFFFFF"),   // Poison
